 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const _1=[["path",{d:"m9 18 6-6-6-6",key:"mthhwq"}]],v1=Jv("chevron-right",_1);var x1={};function S1({images:o,interval:t=5e3}){const[i,r]=He.useState(0),[l,u]=He.useState(!1),h=He.useRef(null),d=_=>{r((_+o.length)%o.length),g()},m=()=>d(i+1),p=()=>d(i-1),g=()=>{h.current&&clearInterval(h.current),h.current=setInterval(()=>{r(_=>(_+1)%o.length)},t)};return He.useEffect(()=>(g(),()=>clearInterval(h.current)),[o,t]),kt.jsxs("div",{className:vi.carousel,onMouseEnter:()=>u(!0),onMouseLeave:()=>u(!1),children:[o.map((_,x)=>kt.jsx("img",{src:`${x1.PUBLIC_URL}${_}`,alt:"",className:`${vi.image} ${x===i?vi.active:vi.inactive}`},x)),kt.jsx("button",{className:`${vi.navBtn} ${vi.left}`,onClick:p,children:kt.jsx(g1,{})}),kt.jsx("button",{className:`${vi.navBtn} ${vi.right}`,onClick:m,children:kt.jsx(v1,{})}),kt.jsx("div",{className:vi.dots,children:o.map((_,x)=>kt.jsx("span",{className:`${vi.dot} ${x===i?vi.activeDot:""}`,onClick:()=>d(x)},x))})]})}const y1={header:"About Me",description:"I’m a Computer Science student Attending the University of Michigan. I pride myself in the ability and passion to learn new and chellenging skills. I have a particular interest in Game development and have been a member of WolverineSoft studio for going on 2 years. Within the scope of game development I am skilled in system devlopment, rendering, and Tools development."},M1=["/images/AboutMe/Image1.png","/images/AboutMe/Image2.jpg","/images/AboutMe/Image3.png","/images/AboutMe/Image4.png","/images/AboutMe/Image5.jpg","/images/AboutMe/Image6.jpg"],E1={about:y1,images:M1};function T1(){const[o,t]=He.useState(null);return He.useEffect(()=>{t(E1)},[]),o?kt.jsxs("section",{className:No.container,id:"About",children:[kt.jsxs("div",{className:No.leftColumn,children:[kt.jsx("h2",{className:No.header,children:o.about.header}),kt.jsx("p",{className:No.description,children:o.about.description})]}),kt.jsx("div",{className:No.rightColumn,children:kt.jsx(S1,{images:o.images,interval:4e3})})]}):null}const b1="_card_15ruv_1",A1="_image_15ruv_18",R1="_overlay_15ruv_24",Dh={card:b1,image:A1,overlay:R1};var C1={};function w1({project:o}){return kt.jsxs("a",{href:o.link,className:Dh.card,children:[kt.jsx("img",{src:`${C1.PUBLIC_URL}${o.image}`,alt:o.title,className:Dh.image}),kt.jsxs("div",{className:Dh.overlay,children:[kt.jsx("h3",{children:o.title}),kt.jsx("p",{children:o.description})]})]})}const D1="_projectBar_1qy6o_1",U1="_inner_1qy6o_13",L1="_cardWrapper_1qy6o_19",N1="_button_1qy6o_26",ms={projectBar:D1,inner:U1,cardWrapper:L1,button:N1};function O1({projects:o,direction:t}){const i=He.useRef(null),[r,l]=He.useState(0),[u,h]=He.useState(0),d=.1,m=.4,p=1,g=.02,[_,x]=He.useState(t==="left"?-.1:d),[M,E]=He.useState(t==="left"?-.1:d),b=()=>{if(console.log("recalc"),i.current){const O=i.current.querySelector(`.${ms.cardWrapper}`);O&&h(O.offsetWidth+y(1))}};He.useEffect(()=>{b()},[o]),He.useEffect(()=>(window.addEventListener("resize",b),()=>window.removeEventListener("resize",b)),[]);const y=O=>O/100*window.innerWidth;He.useEffect(()=>{let O;function N(){x(D=>D+(M-D)*g),l(D=>D+y(_)),O=requestAnimationFrame(N)}return O=requestAnimationFrame(N),()=>cancelAnimationFrame(O)},[M,_]);const v=O=>{if(!u)return{};const N=o.length*u;let D=(O*u+r)%N;return D<-u&&(D+=N),D>N-u&&(D-=N),{transform:`translateX(${D}px)`}};return kt.jsxs("div",{className:ms.projectBar,children:[kt.jsx("button",{onClick:()=>{x(Math.max(p,Math.min(d+m,_+m))),E(d)},className:ms.button,style:{translate:"5.2vw "},children:"◀"}),kt.jsx("div",{ref:i,className:ms.inner,children:o.map((O,N)=>kt.jsx("div",{className:ms.cardWrapper,style:v(N),children:kt.jsx(w1,{project:O})},N))}),kt.jsx("button",{onClick:()=>{x(Math.min(-1,Math.max(-.1-m,_-m))),E(-.1)},className:ms.button,style:{translate:"-7vw "},children:"▶"})]})}const P1="_section_pjjfh_1",z1="_barWrapper_pjjfh_6",B1="_header_pjjfh_10",Uh={section:P1,barWrapper:z1,header:B1},F1=[{header:"WolverineSoft Projects",projects:[{title:"Soul of the Forest",description:"Undertale-inspired RPG",image:"/images/projects/SoulOfTheForest.png",link:""},{title:"Cor Draconis",description:"Fantasy Town Builder/Dungeoning",image:"/images/projects/CorDraconis.png",link:""},{title:"Aether Break",description:"3D speed based platforming",image:"/images/projects/AetherBreak.png",link:""},{title:"Dialogue System",description:"Feature-rich Dialogue System backend.",image:"/images/projects/SotF.png",link:""},{title:"F25 Project",description:"Current semester project",image:"/images/projects/SotF.png",link:""}]},{header:"GameJam Projects",projects:[{title:"Pumpkin Pelter",description:"PvE waves of haunted pumpkins",image:"/images/projects/PumpkinPelter.png",link:""},{title:"Turkey Tussle",description:"Competitive Runaway Turkey Jousting",image:"/images/projects/TurkeyTussle.png",link:""},{title:"Wrong Way!!!",description:"Frisbee Golf gone south",image:"/images/projects/WrongWay.png",link:""},{title:"Spring In My Step",description:"Pogo-Stuck inspired rush to catch the bus",image:"/images/projects/SpringInMyStep.png",link:""},{title:"The World's Hardest Trip",description:"Homage to 'The World's Hardest Game'",image:"/images/projects/TheWorldsHardestTrip.png",link:""}]},{header:"Misc Projects",projects:[{title:"Metroid X Portal",description:"Merger between two classics",image:"/images/projects/MetroidXPortal.png",link:""},{title:"Gluten Gunning",description:"PvP clash of toast technique",image:"/images/projects/GlutenGunning.png",link:""},{title:"Way of the Cards",description:"Use magic cards to conquer a Metroidvania slime dungeon",image:"/images/projects/WayOfTheCards.png",link:""},{title:"Mesh Slicing tool",description:"Unity tool for slicing meshes along a plane",image:"",link:""},{title:"Bullet Hole System",description:"Performance-optimized system for dyanamically drawing decals",image:"",link:""},{title:"Walking Spider Project",description:"Procedural IK animation",image:"",link:""}]}];function I1(){const[o,t]=He.useState([]);return He.useEffect(()=>{t(F1)},[]),kt.jsx("div",{className:Uh.section,id:"Projects",children:o.map((i,r)=>kt.jsxs("div",{className:Uh.barWrapper,children:[kt.jsx("h2",{className:Uh.header,children:i.header}),kt.jsx(O1,{projects:i.projects,direction:r%2===0?"left":"right"})]},r))})}const H1="_container_3a2ud_1",G1="_header_3a2ud_6",V1="_grid_3a2ud_12",k1="_form_3a2ud_22",X1="_input_3a2ud_28",W1="_textarea_3a2ud_29",q1="_submit_3a2ud_39",Y1="_socials_3a2ud_56",j1="_status_3a2ud_77",wi={container:H1,header:G1,grid:V1,form:k1,input:X1,textarea:W1,submit:q1,socials:Y1,status:j1},Z1="Contact Me",K1=[{name:"Pnone - 319-359-8195"},{name:"Email - gavinmcg@umich.edu"},{name:"LinkedIn - Gavin McGinness",url:"https://www.linkedin.com/in/gavinmcginness/"},{name:"GitHub - Gavin-McG",url:"https://github.com/Gavin-McG"}],Q1={header:Z1,socials:K1},Fo={_origin:"https://api.emailjs.com"},J1=(o,t="https://api.emailjs.com")=>{Fo._userID=o,Fo._origin=t},$v=(o,t,i)=>{if(!o)throw"The user ID is required. Visit https://dashboard.emailjs.com/admin/integration";if(!t)throw"The service ID is required. Visit https://dashboard.emailjs.com/admin";if(!i)throw"The template ID is required. Visit https://dashboard.emailjs.com/admin/templates";return!0};class Sv{constructor(t){this.status=t.status,this.text=t.responseText}}const t0=(o,t,i={})=>new Promise((r,l)=>{const u=new XMLHttpRequest;u.addEventListener("load",({target:h})=>{const d=new Sv(h);d.status===200||d.text==="OK"?r(d):l(d)}),u.addEventListener("error",({target:h})=>{l(new Sv(h))}),u.open("POST",Fo._origin+o,!0),Object.keys(i).forEach(h=>{u.setRequestHeader(h,i[h])}),u.send(t)}),$1=(o,t,i,r)=>{const l=r||Fo._userID;return $v(l,o,t),t0("/api/v1.0/email/send",JSON.stringify({lib_version:"3.2.0",user_id:l,service_id:o,template_id:t,template_params:i}),{"Content-type":"application/json"})},tR=o=>{let t;if(typeof o=="string"?t=document.querySelector(o):t=o,!t||t.nodeName!=="FORM")throw"The 3rd parameter is expected to be the HTML form element or the style selector of form";return t},eR=(o,t,i,r)=>{const l=r||Fo._userID,u=tR(i);$v(l,o,t);const h=new FormData(u);return h.append("lib_version","3.2.0"),h.append("service_id",o),h.append("template_id",t),h.append("user_id",l),t0("/api/v1.0/email/send-form",h)},nR={init:J1,send:$1,sendForm:eR};function iR(){const[o,t]=He.useState(null),[i,r]=He.useState("");if(He.useEffect(()=>{t(Q1)},[]),!o)return null;const l=u=>{u.preventDefault(),r("Sending..."),nR.sendForm("service_portfolio","template_portfolio",u.target,"sVHU1KsDRoBP_mjet").then(()=>{r("Message sent successfully ✅"),u.target.reset()},h=>{console.error(h.text),r("Failed to send ❌ Try again later.")})};return kt.jsxs("section",{className:wi.container,children:[kt.jsx("h2",{className:wi.header,children:o.header}),kt.jsxs("div",{className:wi.grid,children:[kt.jsxs("form",{className:wi.form,onSubmit:l,children:[kt.jsx("input",{type:"text",name:"from_name",placeholder:"Your Name",className:wi.input,required:!0}),kt.jsx("input",{type:"email",name:"from_email",placeholder:"Your Email",className:wi.input,required:!0}),kt.jsx("textarea",{name:"message",placeholder:"Your Message",className:wi.textarea,rows:"5",required:!0}),kt.jsx("button",{type:"submit",className:wi.submit,children:"Send"}),i&&kt.jsx("p",{className:wi.status,children:i})]}),kt.jsx("div",{className:wi.socials,children:kt.jsx("ul",{children:o.socials.map((u,h)=>kt.jsx("li",{children:kt.jsx("a",{href:u.url,target:"_blank",rel:"noopener noreferrer",children:u.name})},h))})})]})]})}function aR(){return He.useEffect(FA,[]),kt.jsxs(kt.Fragment,{children:[kt.jsx(XA,{}),kt.jsx(jA,{}),kt.jsx(T1,{}),kt.jsx(I1,{}),kt.jsx(iR,{})]})}dS.createRoot(document.getElementById("root")).render(kt.jsx(He.StrictMode,{children:kt.jsx(aR,{})}));
